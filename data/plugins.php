...
return [
    ...
    's3' => [
        ...
        'download' => 'https://github.com/kanboard/plugin-s3/releases/download/v1.0.3/S3-1.0.3.zip',
        'remote_install' => true,
        'compatible_version' => '>=1.0.32',
    ],
    'bitbucket-webhook' => [
...
- Manage user hourly rates
    ...
    'github-frontend' => [
        ...
        'download' => 'https://github.com/kanboard/plugin-github-frontend/releases/download/v1.0.0/GithubFrontend-1.0.0.zip',
        'remote_install' => true,
    ...
    'milestone' => [
         ...
         'download' => 'https://github.com/oliviermaridat/kanboard-milestone-plugin/releases/download/1.0.33/Milestone-1.0.33-1.zip',
         'remote_install' => true,
         'compatible_version' => '1.0.33',
    ],
    'oauth2' => [
        ...
        'download' => 'https://github.com/kanboard/plugin-oauth2/releases/download/v1.0.0/OAuth2-1.0.0.zip',
        'remote_install' => true,
    ...
    'registration' => [
        ...
        'download' => 'https://github.com/kanboard/plugin-registration/releases/download/v1.0.5/Registration-1.0.5.zip',
        'remote_install' => true,
        'compatible_version' => '>=1.0.32',
    ],
    'relationgraph' => [
    ...
    'rocketchat' => [
        ...
        'download' => 'https://github.com/kanboard/plugin-rocketchat/releases/download/v1.0.3/RocketChat-1.0.3.zip',
        'remote_install' => true,
        'compatible_version' => '>=1.0.32',
    ],
    'sendgrid' => [
