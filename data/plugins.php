...
return [
    ...
    'bitbucket-webhook' => [
        ...
        'download' => 'https://github.com/kanboard/plugin-bitbucket-webhook/releases/download/v1.0.1/BitbucketWebhook-1.0.1.zip',
    ],
    'budget' => [
...
- Manage user hourly rates
        ...
        'download' => 'https://github.com/kanboard/plugin-budget/releases/download/v1.0.6/Budget-1.0.6.zip',
    ],
    'client-certificate' => [
    ...
    'github-auth' => [
        ...
        'download' => 'https://github.com/kanboard/plugin-github-auth/releases/download/v1.0.0/GithubAuth-1.0.0.zip',
    ],
    'github-webhook' => [
        ...
        'download' => 'https://github.com/kanboard/plugin-github-webhook/releases/download/v1.0.1/GithubWebhook-1.0.1.zip',
    ],
    'gitlab-auth' => [
        ...
        'download' => 'https://github.com/kanboard/plugin-gitlab-auth/releases/download/v1.0.0/GitlabAuth-1.0.0.zip',
    ],
    'gitlab-webhook' => [
        ...
        'download' => 'https://github.com/kanboard/plugin-gitlab-webhook/releases/download/v1.0.2/GitlabWebhook-1.0.2.zip',
    ],
    'gogs-webhook' => [
        'title' => 'Gogs Webhook',
        'version' => '1.0.1',
        ...
        'download' => 'https://github.com/kanboard/plugin-gogs-webhook/releases/download/v1.0.1/GogsWebhook-1.0.1.zip',
    ],
    'google-auth' => [
        ...
        'download' => 'https://github.com/kanboard/plugin-google-auth/releases/download/v1.0.1/GoogleAuth-1.0.1.zip',
    ],
    'hipchat' => [
        'title' => 'Hipchat',
        'version' => '1.0.3',
        ...
        'download' => 'https://github.com/kanboard/plugin-hipchat/releases/download/v1.0.3/Hipchat-1.0.3.zip',
    ],
    'jabber' => [
        'title' => 'Jabber',
        'version' => '1.0.3',
        ...
        'download' => 'https://github.com/kanboard/plugin-jabber/releases/download/v1.0.3/Jabber-1.0.3.zip',
    ],
    'mailgun' => [
        'title' => 'Mailgun',
        'version' => '1.0.3',
        ...
        'download' => 'https://github.com/kanboard/plugin-mailgun/releases/download/v1.0.3/Mailgun-1.0.3.zip',
    ],
    'mattermost' => [
        'title' => 'Mattermost',
        'version' => '1.0.1',
        ...
        'download' => 'https://github.com/kanboard/plugin-mattermost/releases/download/v1.0.1/Mattermost-1.0.1.zip',
    ],
    'postmark' => [
        'title' => 'Postmark',
        'version' => '1.0.2',
    ...
    'rocketchat' => [
        ...
        'download' => 'https://github.com/kanboard/plugin-rocketchat/releases/download/v1.0.0/RocketChat-1.0.0.zip',
    ],
    'sendgrid' => [
        'title' => 'Sendgrid',
        'version' => '1.0.2',
        ...
        'download' => 'https://github.com/kanboard/plugin-sendgrid/releases/download/v1.0.2/Sendgrid-1.0.2.zip',
    ],
    'slack' => [
        'title' => 'Slack',
        'version' => '1.0.2',
        ...
        'download' => 'https://github.com/kanboard/plugin-slack/releases/download/v1.0.2/Slack-1.0.2.zip',
    ],
    'sms-2fa' => [
        ...
        'download' => 'https://github.com/kanboard/plugin-sms-2fa/releases/download/v1.0.0/SmsTwoFactor-1.0.0.zip',
    ],
    'subtask-forecast' => [
...
- Subtask time tracking is calculated according to the timetable
        ...
        'download' => 'https://github.com/kanboard/plugin-timetable/releases/download/v1.0.6/Timetable-1.0.6.zip',
    ],
    'wunderlist' => [
        'title' => 'Wunderlist',
        'version' => '1.0.1',
